...
var bellSound, downSound, winSound, loseSound, bgSound;
...
function preload() {
  ...
  downSound = loadSound("dump.mp3");
  winSound = loadSound("win.mp3");
  loseSound = loadSound("lose.mp3");
  bgSound = loadSound("backmusic.mp3");
}
...
if(stormCloud.x === 1000) {
  ...
  textSize(20);
  text("Press left and right arrow keys to move around!", 700, 100);
}
